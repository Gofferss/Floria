  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // прогресса", но по окружности через stroke-dashoffset. Длина
        // окружности зависит от размера кружка (разная на мобильном и
        // десктопе), поэтому берётся из CSS-переменной --ring-c, а не
        // зашита числом, как в story-progress.
        "story-ring": {
          "0%": { strokeDashoffset: "var(--ring-c)" },
