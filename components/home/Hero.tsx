  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-lavender-100 via-lavender-50 to-white">
      ...
      <div className="relative z-20 mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 py-10 sm:gap-12 sm:px-6 sm:py-14 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-24">
        ...
        {/* Крупный вырезанный букет — см. README/список изображений: /public/hero-bouquet.png */}
        <div className="relative mx-auto aspect-[4/3] w-full max-w-sm sm:max-w-md lg:aspect-square lg:max-w-none">
          {/* Мягкое свечение под букетом вместо прежней декоративной "капли" —
              настоящее фото не нуждается в абстрактной подложке, только в глубине */}
          <div
