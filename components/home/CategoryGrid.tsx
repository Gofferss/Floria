...
export async function CategoryGrid() {
  ...
  return (
    // Градиентная подложка в тон хиро-блоку — по макету оба экрана читаются
    // как одно полотно, а не как две разные страницы. Полоса выходит за
    // пределы контента, поэтому фон живёт на внешней секции, а отступы — на
