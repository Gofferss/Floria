...
import { toggleStoryActive } from "@/lib/actions/stories";

export function ToggleActiveButton({ storyId, isActive }: { storyId: string; isActive: boolean }) {
  ...
  function handleClick() {
    ...
    startTransition(async () => {
      const result = await toggleStoryActive(storyId, !isActive);
      if (!result.success) {
